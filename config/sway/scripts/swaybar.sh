# Stolen from https://git.sr.ht/~oscarcp/ghostfiles/tree/master/item/sway_wm
...
echo "🎧 $song_status $media_artist - $media_song | $network_active | 🏋 $loadavg_5min | $audio_active $audio_volume% | $battery_pluggedin $battery_charge | $date_and_week 🕘 $current_time"
